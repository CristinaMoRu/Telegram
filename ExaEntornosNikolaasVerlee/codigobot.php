<?php
// configurar token
$botToken = "204489442:AAFph_VVkoBXJqmEWGFsPmMuLfpYDTmpIBI";
...
while(true){
    ...
    header("Location: https://api.telegram.org/bot204489442:AAFph_VVkoBXJqmEWGFsPmMuLfpYDTmpIBI/getupdates");
}
